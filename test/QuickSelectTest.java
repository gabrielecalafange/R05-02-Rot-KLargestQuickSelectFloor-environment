...
public class QuickSelectTest {
    ...
    @Before
    public void init() { this.implementacao = new QuickSelect<>(); }

    public void verificaEstatisticaDeOrdem (Integer[] array, int k, Integer retornoEsperado) {
        assertEquals(retornoEsperado, this.implementacao.quickSelect(array.clone(), k));
    }

    public void verificaEstatisticaDeOrdem (Integer[] array, int k, int retornoEsperado) {
        assertEquals(Integer.valueOf(retornoEsperado), this.implementacao.quickSelect(array.clone(), k));
    }
